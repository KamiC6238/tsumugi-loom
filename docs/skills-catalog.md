...
7. `web-design-guidelines` 作为项目级 UX/UI review node skill 安装在 `.github/skills/web-design-guidelines/SKILL.md`，来源为 Vercel Labs Web Interface Guidelines，经 `antfu/skills` 收录。
